...
/-!
# CppFormalization.Cpp2.Static.Pure.Inversions

Pure static inversion facts.

This file contains inversion facts for well-formedness and typing only.
It intentionally does not import `Static.Safety.Assumptions`, and therefore
does not mention `NoUninit*`, `NoInvalidRef*`, or `IdealAssumptions`.
-/
