...
/-!
# CppFormalization.Cpp2.Semantics.Facts.ScopeDepth

Scope-stack depth facts for statement/block big-step semantics.

The semantic OpenScope/CloseScope simp bridge lives here, not in Core.Facts.RuntimeState.
-/
