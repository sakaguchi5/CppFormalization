...
theorem stmt_break_preserves_scoped_typed_state_concrete
    ...
    ScopedTypedStateConcrete Δ σ' := by
  intro hσ hready
  exact stmt_control_preserves_scoped_typed_state_of_compatible mkWhileCtx hcomp hσ hready
...
theorem block_body_break_preserves_scoped_typed_state_concrete
    ...
    ScopedTypedStateConcrete Δ σ' := by
  intro hσ hready
  exact block_control_preserves_scoped_typed_state_of_compatible mkWhileCtx hcomp hσ hready
