...
theorem externalPieces_of_ready_from_glue_v3_boundaryCoherent
    ...
    BoundaryCoherentV3
      ...
      (assembleExternalPiecesV3 G huse hsuppRun hgen hsuppRefl hcompat) := by
  let p : ExternalPiecesV3 Γ σ st :=
    assembleExternalPiecesV3 G huse hsuppRun hgen hsuppRefl hcompat
...
theorem externalPieces_of_ready_from_glue_v3_boundary_eq
  ...
  externalPieces_of_ready_from_glue_v3_boundaryCoherent G huse hsuppRun hgen hsuppRefl hcompat
